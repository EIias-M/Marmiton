...
<body>
	...
	<form action="routeurUstensile.php" method="get">
		...
		<p>
			...
			<input type="text" name="NomUstensile" required>
		</p>
		<p>
			<label>Le lien de la photo dans le fichier:</label>
			<input type="text" name="photoUstensile" required>
		</p>
		<p>
			<input type="submit" name="envoyer" value="créer l'ustensile">
		</p>
	</form>
</body>
</html>