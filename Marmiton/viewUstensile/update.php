...
<body>
	...
	<form action="routeurUstensile.php" method="get">
		<input type="hidden" name="action" value="updated">
		<p>
			<label>nom de l'ustensile:</label>
			<input type="text" name="NomUstensile" value="<?php echo $Ust->getnomUstensile(); ?>" readonly>
		</p>
		<p>
			<label>Quantié d'ustensile necessaire a la recette :</label>
			<input type="text" name="QuantiteUstensile" value="<?php echo $Ust->getQuantiteUstensile(); ?>" required>
		</p>
		<p>
			<label>fait :</label>
			<input type="text" name="PhotoUstensile" value="<?php echo $Ust->getPhotoUstensile(); ?>" required>
		</p>
		<p>
			<input type="submit" name="envoyer" value="modifier l'ustensile">
		</p>
	</form>
</body>
</html>