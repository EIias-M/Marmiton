...
<body>
	...
	<form action="routeurUtilisateur.php" method="get">
		<input type="hidden" name="action" value="updated">
		<p>
			<label>Votre pseudo:</label>
			<input type="text" name="pseudo" value=<?php echo $pseudo ?> readonly>
		</p>

		<p>
			<label>Choisir un nouveau lien vers votre nouvelle photo de profil</label>
			<input type="text" name="photo" value="" required>
		</p>
		
			<input type="submit" name="envoyer" value="modifier la photo de profil">
		</p>
	</form>
</body>
</html>