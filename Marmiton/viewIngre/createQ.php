...
<body>
	...
	<form action="routeurIngre.php" method="get">
		...
		<p>
			...
			<input type="text" name="nomIngredient" readonly>
		</p>

		<p>
		<label>La Quantité de l'Ingrédient :</label>
			<input type="text" name="QuantiteIngredient" required>
		</p>

		<p>
		<label>L'unité de mesure :</label>
			<input type="text" name="Unité" required>
		</p>

		<!-- afficher la photo -->

		<p>
			<input type="submit" name="envoyer" value="créer l'ingrédient">
		</p>
	</form>
</body>
</html>